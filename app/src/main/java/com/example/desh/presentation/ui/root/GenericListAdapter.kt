...
abstract class GenericListAdapter<T : Any>(@IdRes val layoutId: Int, inline val bind: (item: T, holder: BaseViewHolder, itemCount: Int) -> Unit
) : ListAdapter<T, GenericListAdapter.BaseViewHolder>(BaseItemCallback<T>()) {
